...
/***/ function(module, exports, __webpack_require__) {
	...
	var SurveyQuestionMatrix = exports.SurveyQuestionMatrix = function (_super) {
	    ...
	    SurveyQuestionMatrix.prototype.render = function () {
	        ...
	        return React.createElement("table", { className: this.css.root }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("td", null), React.createElement("td", null, React.createElement("div", { className: "mood-icon mood-icon--bad" })), React.createElement("td", null), React.createElement("td", null), React.createElement("td", null), React.createElement("td", null), React.createElement("td", null, React.createElement("div", { className: "mood-icon mood-icon--good" }))), React.createElement("tr", null, firstTH, headers)), React.createElement("tbody", null, rows));
	    };
